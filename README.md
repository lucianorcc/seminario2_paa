# 🔵 Problema da Partição de Conjuntos  
### _Set Partition Problem — Backtracking & Dynamic Programming_

[![Python](https://img.shields.io/badge/Python-3.10+-blue.svg)]()
[![Status](https://img.shields.io/badge/Projeto-Acadêmico-green.svg)]()
[![Algoritmos](https://img.shields.io/badge/Backtracking-DP-orange.svg)]()
[![Complexidade](https://img.shields.io/badge/NP--Completo-red.svg)]()

---

## 📘 Sobre o Repositório

Este repositório contém os materiais do **Seminário Avaliativo II** da disciplina  
**Projeto e Análise de Algoritmos (PAA)** do **Mestrado em Ciência da Computação – PROCC/UFS**.
